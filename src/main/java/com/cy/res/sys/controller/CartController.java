...
public class CartController {
	...
	//加入购物车
	@RequestMapping(value="/shopping/buyone")
	@ResponseBody
	public JsonResult buyOne(Integer productId,HttpServletRequest request){
		Cart buyerCart = null;
		//1,获取Session中的购物车
		HttpSession session = request.getSession();
		Object cart = session.getAttribute("cart");
